...
import { GomokuScene } from './GomokuScene'
...
onMounted(() => {
  ...
  phaserGame.events.on('ready', () => {
    gomokuScene = phaserGame.scene.getScene('GomokuScene')
...
defineExpose({
  updateState: (newState) => {
    if (gomokuScene) {
      gomokuScene.updateFromServer(newState)
    }
  }
})
</script>
